 ...
 */
export * from "@aws-sdk/client-ses/dist-types/SESClient";
export * from "@aws-sdk/client-ses/dist-types/SES";
export { ClientInputEndpointParameters } from "@aws-sdk/client-ses/dist-types/endpoint/EndpointParameters";
export type { RuntimeExtension } from "@aws-sdk/client-ses/dist-types/runtimeExtensions";
export type { SESExtensionConfiguration } from "@aws-sdk/client-ses/dist-types/extensionConfiguration";
export * from "@aws-sdk/client-ses/dist-types/commands";
export * from "@aws-sdk/client-ses/dist-types/pagination";
export * from "@aws-sdk/client-ses/dist-types/waiters";
export * from "@aws-sdk/client-ses/dist-types/models/enums";
export * from "@aws-sdk/client-ses/dist-types/models/errors";
export type * from "@aws-sdk/client-ses/dist-types/models/models_0";
export { SESServiceException } from "@aws-sdk/client-ses/dist-types/models/SESServiceException";
